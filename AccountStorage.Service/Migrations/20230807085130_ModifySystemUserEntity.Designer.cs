...
namespace AccountStorage.Service.Migrations
{
    ...
    [Migration("20230807085130_ModifySystemUserEntity")]
    partial class ModifySystemUserEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountStorage.Service.Entities.Account", b =>
                {
                    ...
                    b.HasOne("AccountStorage.Service.Entities.SystemUser", "User")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AccountStorage.Service.Entities.SystemUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
